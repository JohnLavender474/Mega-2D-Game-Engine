...
/**
 * Converts a Kotlin array to an [ObjectSet].
 * 
...
/**
 * Converts a LibGDX [com.badlogic.gdx.utils.Array] to an [ObjectSet].
 * 
 * @return the object set
 */
...
/**
 * Converts a Kotlin array to an [OrderedSet].
 *
 * @return the object set
 */
...
/**
 * Converts a LibGDX [com.badlogic.gdx.utils.Array] to an [OrderedSet].
 *
 * @return the object set
 */
