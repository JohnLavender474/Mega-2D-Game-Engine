    ...
    DescribeSpec({
        describe("CullableOnEvent") {
            it("should be culled on specified event") {
                ...
                val cullableOnEvent =
                    com.mega.game.engine.cullables.CullableOnEvent(cullOnEvent = { _event -> _event.key == eventKey })
            ...
            it("should not be culled on different event") {
                ...
                val cullableOnEvent =
                    com.mega.game.engine.cullables.CullableOnEvent(cullOnEvent = { _event -> _event.key == "differentEvent" })
