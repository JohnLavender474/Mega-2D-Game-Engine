...
object RectangleExtensions {
    ...
    fun Rectangle.getCenterX() = getCenter().x

    fun Rectangle.getCenterY() = getCenter().y
    ...
    fun Rectangle.setCenterX(centerX: Float) = setCenter(centerX, getCenterY())

    fun Rectangle.setCenterY(centerY: Float) = setCenter(getCenterX(), centerY)
    ...
    fun Rectangle.setToPoint(point: Vector2, position: Position) =
            when (position) {
    ...
    fun Rectangle.getPoint(position: Position) =
            when (position) {
