...
/**
 * A [IDamager] is an object that can deal damage to a [IDamageable]. The [IDamager] is responsible
 * for determining whether it can damage a [IDamageable] and how much damage it deals.
 *
 * @see IDamageable
 */
interface IDamager {
