...
/**
 * A [DamageComponent] is a [GameComponent] that contains a [Damageable] and a list of [Damager]s.
 ...
 */
class DamageComponent(internal var damageable: Damageable) : GameComponent {
