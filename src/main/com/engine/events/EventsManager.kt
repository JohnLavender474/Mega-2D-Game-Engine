...
class EventsManager(
     ...
     */
    constructor(
        debugEventFilter: Predicate<Event>, debugListenerFilter: Predicate<IEventListener>
    ) : this({ debugEventFilter.test(it) }, { debugListenerFilter.test(it) })
     ...
     */
    override fun clearListeners() = if (running) setToClearListeners = true else clearListenersNow()
